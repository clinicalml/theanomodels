...
def nlinear_trans_learn(z, fxn_params = {}, ns=None): 
    ...
    #return (fxn_params['alpha']*z)**2+0.1*z
    #return np.sin(fxn_params['alpha']*z)+0.1*z
    return np.tanh(fxn_params['alpha']*z)+np.sin(0.3*z)+0.1*z
def obs_learn(z,fxn_params = {}, ns = None):
    return 0.5*z
params_synthetic['synthetic11']                = {}
params_synthetic['synthetic11']['params']      = {}
params_synthetic['synthetic11']['params']['alpha'] = 0.137
...
params_synthetic['synthetic11']['obs_cov']     = 0.01
...
params_synthetic['synthetic11']['docstr']      = '$z_t\sim\mathcal{N}(\sin(\\alpha z_{t-1}),5)$\n$x_t\sim\mathcal{N}(0.5z_t,5)$'
